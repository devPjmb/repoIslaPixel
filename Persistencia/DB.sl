...
--
-- Servidor: ps2000.cylxx2vnzs3w.us-east-1.rds.amazonaws.com:3306
-- Tiempo de generación: 27-02-2018 a las 13:01:59
...
--
ALTER TABLE `MenuByRole`
  MODIFY `MenuByRoleID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=52;
--
-- AUTO_INCREMENT de la tabla `Page`
--
ALTER TABLE `Page`
  MODIFY `PageID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=170;
--
