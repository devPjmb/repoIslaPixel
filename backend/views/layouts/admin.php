                        ...
                        <ul class="nav navbar-nav pull-right">
                            <li class="dropdown dropdown-user">
                                <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                                    <img alt="" class="img-circle" src="<?= $userInfo['PhotoUrl']? Yii::getAlias('@proyect').'/img/profile/'.$userInfo['PhotoUrl']:Yii::getAlias('@proyect').'/img/profile/UserDefault.svg';?>" />
                    ...
                    <div class="page-sidebar navbar-collapse collapse">
                        <ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 20px">
                            <li class="nav-item" id="myimageDiv">
                                <a href="<?= Yii::$app->urlManager->createUrl('/profile'); ?>">
                                    <img src="<?= $userInfo['PhotoUrl']? Yii::getAlias('@proyect').'/img/profile/'.$userInfo['PhotoUrl'] : Yii::getAlias('@proyect').'/img/profile/UserDefault.svg'.$userInfo['PhotoUrl'];?>" alt="Imagen de Perfil" class="img-responsive img-circle" style="margin: 0 auto 10px;">
                                </a>   
                            </li>
