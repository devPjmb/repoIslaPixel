...
use backend\assets\AppAssetLayoutAll;
    ...
    $this->title = 'Sección de Contacto';
 ?>
...
<?= DataTables::widget([
    ...
    'columns' => [
        ...
        [
            ...
            'value' => function ($data) {
                $htm = "<img src='".Yii::getAlias("@proyect")."/img/contact/".$data->imgBackground."' style='margin: auto; width: auto; height: 30px;'>";
        ...
        [
            ...
            'buttons' => [
                'delete' => function($url, $model){
                    return Html::a('<span class="fa fa-trash"></span>', ['delete', 'id' => $model->ContactID], [
    ...
    <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body row">
            <div class="col-md-2">
                <?= $form->field($ModelContact, 'Status')->checkBox(['class'=>'cm-toggle']) ?>
            </div>
            <div class="col-md-6">
                <?= $form->field($ModelContact, 'TempImg')->fileInput(['class'=>'imgpostchang'])->label(false); ?>
            </div>
            <div class="col-md-4">
