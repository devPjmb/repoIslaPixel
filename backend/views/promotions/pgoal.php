...
<section class="container-fluid flex flex-column flex-align-center">
	...
	<section class="col-sm-12 col-md-11">
		...
		?>
			...
			<div class="row">
				<div class="col-md-6">
					<?= $form->field($pGoal, 'Name')->textInput() ?>
				</div>
				<div class="col-md-6">
					<?= $form->field($pGoal, 'Duration')->textInput(['type'=>'number']) ?>
				</div>
			</div>

			<div class="row">
				<div class="col-md-6">
					<?= $form->field($pGoal, 'Prize')->textInput(['type'=>'number']) ?>
				</div>
				<div class="col-md-6">
					<?= $form->field($pGoal, 'Target')->textInput(['type'=>'number']) ?>
				</div>
			</div>
