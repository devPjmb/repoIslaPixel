...
<div class="container-fluid">
    ...
    <h1>Promociones</h1>
    <hr>
<?= Html::a('<i class="fa fa-plus"></i> Create New Promotion', ['/promotions/promotion'], ['class'=>'btn btn-success']) ?>
<br><br><br>
<div class="row-fluid">
<?php 
echo DataTables::widget([
    ...
    'columns' => [
        ...
        [
            ...
            'value' => function ($model) {
                return date('d/m/Y',$model->ExpirationDate);
            },
            'format' => 'text',
            'contentOptions'=>['style'=>'vertical-align:middle;'],
        ],
        ...
        [
            ...
            'buttons' => [
                'delete' => function($url, $model){
                    return Html::a('<span class="fa fa-trash"></span>', ['deletepromotion', 'id' => $model->PromotionID], [
                ...
                'update' => function($url, $model){
                    return Html::a('<span class="fa fa-edit"></span>', ['promotion', 'id' => $model->PromotionID,], [
                        'class' => 'btn btn-info',
                    ]);
                }
