...
<section class="container-fluid flex flex-column flex-align-center">
	...
	<section class="col-sm-12 col-md-11">
		...
		?>
			...
			<div class="row">
				<div class="col-md-6">
					<?= $form->field($Promotion, 'Name')->textInput() ?>
				</div>
				<div class="col-md-6">
					<?php echo $form->field($Promotion, 'ExpirationDate')->widget(
			...
			<div class="row">
				<div class="col-md-6">
					<?php echo $form->field($Promotion,'Cost')->textInput(['type' => 'number']); ?>
				</div>
				<div class="col-md-6">
					<?php echo $form->field($Promotion,'Bonus')->textInput(['type' => 'number']); ?>
				</div>
			</div>
